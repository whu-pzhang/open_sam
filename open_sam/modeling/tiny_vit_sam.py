...
class PatchMerging(nn.Module):
    ...
    def __init__(self,
        ...
        stride_c = 2
        if (out_channels == 320 or out_channels == 448 or out_channels == 576):
            stride_c = 1
...
class TinyViT(BaseModule):
    ...
    def __init__(self,
        ...
        for i in range(self.num_stages):
            ...
            curr_resolution = (patches_resolution[0] //
                               (2**(i - 1 if i == 3 else i)),
    ...
    def forward(self, x):
        ...
        for i, stage in enumerate(self.stages):
            ...
            if i in self.out_indices:
                ...
                B, L, C = x.shape
                x_reshape = x.view(B, *stage.resolution, C)
                x_reshape = x_reshape.permute(0, 3, 1, 2)
                if self.out_channels > 0:
